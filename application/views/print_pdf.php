...
foreach ($entradas->result_array() as $row) {
    ...
    $lista .= '<tr>' .
        ...
        '<td style=" text-align: right;" class="row">' . $row['value'] . ' Akz</td>' .
        '<td style=" text-align: left;"  class="row">' . $row['title'] . '</td>' .
        '</tr>';
...
$html = "
    ...
    <table style='border-spacing: 0px; margin-top: 10px; margin-bottom: 10px'  width='1000' align='left' >
       ...
       <th style='width: 50px; text-align: left'>#</th>
        ...
        <th style=' padding: 10px; width: 200px;  text-align: left'>Data de entrada</th>
        <th  style=' padding: 10px;  text-align: left'>Valor da compra</th>
...
<hr>
<span style='font-size: 9px; '>Total de valor dos livros .: " . $valor . ".00 Akz </span><br>
